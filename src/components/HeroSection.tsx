  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center mt-20 ">
      ...
      <div className=" md: text-left flex-col p-5 sm:p-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-5 lg:gap-10 mb-5">
          <button className="btn text-[10px] sm:text-[13px] md:text-[13px] lg:text-[20px] w-full border border-gray-200 bg-linear-to-r from-[#F97316] to-[#EC4899] text-white transition duration-300">
            Explore Technologies
          </button>
          <button className="btn text-[10px] sm:text-[13px] md:text-[13px] lg:text-[20px] w-full border border-gray-200 text-[#475569] hover:bg-linear-to-r from-[#F97316] to-[#EC4899] hover:text-white transition duration-300">
            Learn More
          </button>
        </div>
      </div>
